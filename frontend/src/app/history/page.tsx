    ...
    <div className="space-y-6">
      ...
      {calls.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No calls analyzed yet</h3>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <div className="mt-3 flex items-center space-x-4">
                    <div className={`px-3 py-1 rounded-full text-sm font-medium ${getSentimentColor(call.avg_sentiment)}`}>
                      {getSentimentLabel(call.avg_sentiment)} ({call.avg_sentiment.toFixed(2)})
                    </div>
                  </div>
                </div>
